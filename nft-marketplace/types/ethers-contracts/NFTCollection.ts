...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface NFTCollectionInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "batchMint" | "getApproved" | "isApprovedForAll" | "maxBatchSize" | "mint" | "mintFee" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setMintFee" | "supportsInterface" | "symbol" | "tokenURI" | "tokensByOwner" | "totalSupply" | "transferFrom" | "transferOwnership" | "withdraw"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "MetadataUpdate" | "MintFeeUpdated" | "NFTMinted" | "OwnershipTransferred" | "Transfer"): EventFragment;

    encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'balanceOf', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'batchMint', values: [AddressLike, string[], BigNumberish]): string;
encodeFunctionData(functionFragment: 'getApproved', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'isApprovedForAll', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'maxBatchSize', values?: undefined): string;
encodeFunctionData(functionFragment: 'mint', values: [AddressLike, string, BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'tokensByOwner', values: [AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
    ...
    export namespace NFTMintedEvent {
      export type InputTuple = [tokenId: BigNumberish, creator: AddressLike, tokenURI: string];
      export type OutputTuple = [tokenId: bigint, creator: string, tokenURI: string];
      export interface OutputObject {tokenId: bigint, creator: string, tokenURI: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    batchMint: TypedContractMethod<
      [to: AddressLike, uris: string[], royaltyFraction: BigNumberish, ],
      [bigint[]],
      'payable'
    >
    ...
    maxBatchSize: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    mint: TypedContractMethod<
      [to: AddressLike, uri: string, royaltyFraction: BigNumberish, ],
      [bigint],
      'payable'
    >
...
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'maxBatchSize'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'MintFeeUpdated(uint256,uint256)': TypedContractEvent<MintFeeUpdatedEvent.InputTuple, MintFeeUpdatedEvent.OutputTuple, MintFeeUpdatedEvent.OutputObject>;
      ...
      'NFTMinted(uint256,address,string)': TypedContractEvent<NFTMintedEvent.InputTuple, NFTMintedEvent.OutputTuple, NFTMintedEvent.OutputObject>;
